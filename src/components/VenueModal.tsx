...
const VenueModal: React.FC<VenueModalProps> = ({ venue, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] shadow-2xl transform transition-all duration-300 scale-100 flex flex-col">
        {/* Header */}
        <div className="relative">
          ...
          <div className="absolute bottom-4 right-4 bg-rose-500/90 backdrop-blur-sm px-4 py-2 rounded-lg">
            <span className="text-white font-bold text-lg">{venue.priceRange}</span>
          </div>
        </div>
        ...
        <div className="p-8 overflow-y-auto flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            {/* Hours & Details */}
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Hours & Details</h3>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-rose-50 p-4 rounded-lg text-center">
                ...
                <p className="text-sm font-medium text-gray-900">{venue.rating} Rating</p>
              </div>
              <div className="bg-rose-50 p-4 rounded-lg text-center">
              ...
              <div className="bg-rose-50 p-4 rounded-lg text-center">
                ...
                <p className="text-sm font-medium text-gray-900">Great Location</p>
              </div>
              <div className="bg-rose-50 p-4 rounded-lg text-center">
                <Award className="text-rose-500 mx-auto mb-2" size={24} />
                <p className="text-sm font-medium text-gray-900">{venue.type}</p>
              </div>
            </div>
          </div>
        ...
        <div className="sticky bottom-0 bg-white border-t border-gray-200 p-6 rounded-b-2xl">
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="flex-1 bg-gradient-to-r from-rose-500 to-rose-600 text-white py-4 px-6 rounded-xl hover:from-rose-600 hover:to-rose-700 transition-all duration-300 font-semibold text-lg hover:scale-105 hover:shadow-lg transform">
              Make Reservation
            </button>
            <button className="flex-1 bg-gray-100 text-gray-800 py-4 px-6 rounded-xl hover:bg-gray-200 transition-all duration-300 font-semibold text-lg hover:scale-105 hover:shadow-lg transform">
              Get Directions
            </button>
          </div>
        </div>
